      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          ...
          filtered.map((question) => {
            ...
            const createdDate = formatDate(question.createdAt);
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    {/* Badges row — with createdAt on the right */}
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {/* ✅ createdAt badge — right aligned */}
                      {createdDate && (
                        <span className="ml-auto px-2 py-0.5 bg-slate-50 text-slate-400 text-xs rounded border border-slate-200">
                          {createdDate}
                        </span>
                      )}
                    </div>
