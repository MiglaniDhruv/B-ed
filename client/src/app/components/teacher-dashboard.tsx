      ...
      <body>
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:12px;">
          <tr>
            <td width="60">&nbsp;</td>
            <td align="center">
              <h1 style="font-size:20px;font-weight:700;margin:0;padding:0;">${quiz.title}</h1>
            </td>
            <td width="60" align="right" valign="middle">
              ${logoBase64 ? `<img src="${logoBase64}" width="56" height="56" style="width:56px;height:56px;object-fit:contain;" />` : `&nbsp;`}
            </td>
          </tr>
        </table>
        <div class="meta">
            ...
            <Card className="bg-white border border-slate-200 rounded-xl overflow-hidden">
              ...
              {analytics.totalAttempts === 0 ? (
                ...
                <div className="divide-y divide-slate-50">
                  ...
                  {(() => {
                    const filtered = analytics.leaderboard.filter((entry) =>
                      entry.studentName
                        .trim()
                        .toLowerCase()
                        .includes(analyticsSearch.toLowerCase()),
                    );
